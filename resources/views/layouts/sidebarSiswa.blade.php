  <div class="col-md-3">
    <div class=" p-4 text-white rounded-3" style="background: #579924; height:335px;">
      <ul class="list-unstyled ps-0">
        ...
        <li class="mb-2">
          <div class="d-grid gap-2">
            <a class="btn btn-toggle align-items-center rounded collapsed text-start" id="sidenav_menu" href="#">My Course</a>
          </div>
        </li>
        <li class="mb-2">
          <div class="d-grid gap-2">
            <a class="btn btn-toggle align-items-center rounded collapsed text-start" id="sidenav_menu" href="#">Assesment</a>
          </div>  
        </li>
        <li class="mb-2">
          <div class="d-grid gap-2">
            <a class="btn btn-toggle align-items-center rounded collapsed text-start" id="sidenav_menu" href="#">Hasil Assessment</a>
          </div>
        </li>
        <li class="mb-2">
          <div class="d-grid gap-2">
        ...
        <li class="mb-0">
          <div class="d-grid gap-2">
            <a class="btn btn-toggle align-items-center rounded collapsed text-start" id="sidenav_menu" href="#">Riwayat Transaksi</a>
          </div>
        </li>
      </ul>
    </div>
